  ...
  return (
    <section className="w-full h-[665px]">
      <div className="bg-yellow-30 py-10 rounded-t-4xl">
        <h2 className="text-black text-center text-4xl w-full text-shadow">{t('maps.title')}</h2>
        <h2 className="text-black text-center text-4xl font-extrabold w-full text-shadow">{t('maps.description')}</h2>        
      </div>
